          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                SvgPicture.asset('assets/logos_svg/gastoclub_logo.svg',width: 250,),
                SizedBox(height: 40,),
                Text('Gasto Club',style: TextStyle(fontSize: 50,fontFamily: 'Inter-Bold', fontWeight: FontWeight.w900),),
                SizedBox(height: 25,),
                SizedBox(
                  width: 350,
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(color: const Color.fromARGB(100, 255, 255, 255)),
                      ),
